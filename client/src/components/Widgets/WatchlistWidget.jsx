      ...
      >
        <div>
          <div
            ...
            data-testid={`watchlist-symbol-${index}`}
          >
        ...
        <div className="text-right">
          <div
            className="font-mono text-card-foreground text-sm"
            data-testid={`watchlist-price-${index}`}
          >
          ...
          >
            <i
              className={`fas ${
                (item.change || 0) >= 0 ? "fa-arrow-up" : "fa-arrow-down"
              } text-xs mr-1`}
            ></i>
